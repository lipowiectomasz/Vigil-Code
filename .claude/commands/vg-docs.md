---
name: vg-docs
description: "Query technical documentation for any technology in Vigil Guard stack (41+ technologies)"
---
...
```bash
/vg-docs <technology> [topic]
/vg-docs list [category]
/vg-docs search <keyword>
```
...
**Infrastructure (4):**
docker, docker-compose, caddy, nginx
...
💡 Use /vg-docs <technology> to get detailed information
```
...
- Add **topic** for specific documentation: `/vg-docs react hooks`
- Use **search** when unsure of technology: `/vg-docs search "authentication"`
...
→ Check `/vg-docs list` for correct name (e.g., `react` not `reactjs`)
...
2. Load tech-stack.json from `.claude/agents/vg-tech-docs-navigator/`
