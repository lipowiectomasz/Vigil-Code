...
description: Microsoft Presidio PII detection API. Use for dual-language PII (Polish + English), spaCy models, entity deduplication, custom recognizers (PESEL, NIP, REGON), and performance optimization.
version: 1.6.11
