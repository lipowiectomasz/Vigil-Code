...
description: Express.js backend API development for Vigil Guard. Use for endpoint creation, JWT authentication, RBAC, ClickHouse queries, rate limiting, CORS management, and audit logging.
version: 1.6.11
